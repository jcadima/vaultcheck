...
class P001_WorldReadable extends BaseCheck
{
        ...
        if ($perms & 0x0004) {
            return $this->collection(
                $this->finding(
                    ...
                    sprintf('.env is world-readable (permissions: %s). Any user on the system can read your secrets.', $this->formatPerms($perms)),
                    'Run: chmod 600 .env',
                    $path,
                )
            );
